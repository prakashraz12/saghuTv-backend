...
import { createCategory, deleteCategory, getCategoryById, getListOfCategory, updateCategory } from "../controllers/category.controller.js";
...
router.delete("/update", authUser, authorizationUser(["admin"]), deleteCategory);
...
router.get("/get/:id", authUser, authorizationUser(["admin"]), getCategoryById)
